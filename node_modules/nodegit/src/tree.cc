...
GitTree::GitTree(git_tree *raw, bool selfFreeing, bool shouldDuplicate)
{
  if (shouldDuplicate) {
    (&this->raw, raw);
    selfFreeing = true;
...
Local<v8::Value> GitTree::New(const git_tree *raw, bool selfFreeing, bool shouldDuplicate)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), Nan::New(shouldDuplicate) };
  return scope.Escape(Nan::NewInstance(Nan::New(GitTree::constructor_template), 3, argv).ToLocalChecked());
}
...
// end convert_from_v8 block
  ...
  {
    LockMaster lockMaster(true        ,    Nan::ObjectWrap::Unwrap<GitTree>(info.This())->GetValue()
                          ,    from_id
                         );
...
// start convert_to_v8 block
    ...
    if (result != NULL) {
      // GitTreeEntry result
      to = GitTreeEntry::New(result, false , true );
    } else {
      to = Nan::Null();
    }
...
void GitTree::EntryBypathWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->root
                          ,baton->path
                         );
...
// end convert_from_v8 block
  ...
  {
    LockMaster lockMaster(true        ,    from_e1
                          ,    from_e2
                         );
...
// end convert_from_v8 block
  ...
  {
    LockMaster lockMaster(true        ,    from_dest
                          ,    from_source
                         );
...
// end convert_from_v8 block
  ...
  {
    LockMaster lockMaster(true        ,    from_object_out
                          ,    from_repo
                          ,    from_entry
                         );
