...
GitPathspec::GitPathspec(git_pathspec *raw, bool selfFreeing, bool shouldDuplicate)
{
  if (shouldDuplicate) {
    (&this->raw, raw);
    selfFreeing = true;
...
Local<v8::Value> GitPathspec::New(const git_pathspec *raw, bool selfFreeing, bool shouldDuplicate)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), Nan::New(shouldDuplicate) };
  return scope.Escape(Nan::NewInstance(Nan::New(GitPathspec::constructor_template), 3, argv).ToLocalChecked());
}
...
NAN_METHOD(GitPathspec::Free)
{
  ...
  if (Nan::ObjectWrap::Unwrap<GitPathspec>(info.This())->GetValue() != NULL) {
    ...
    {
      LockMaster lockMaster(true        ,    Nan::ObjectWrap::Unwrap<GitPathspec>(info.This())->GetValue()
                           );
...
void GitPathspec::MatchIndexWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->index
                          ,baton->ps
                         );
...
// end convert_from_v8 block
  ...
  {
    LockMaster lockMaster(true        ,    from_m
                         );
...
void GitPathspec::MatchTreeWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->tree
                          ,baton->ps
                         );
...
// end convert_from_v8 block
  ...
  {
    LockMaster lockMaster(true        ,    from_pathspec
                         );
