...
GitSubmodule::GitSubmodule(git_submodule *raw, bool selfFreeing, bool shouldDuplicate)
{
  if (shouldDuplicate) {
    (&this->raw, raw);
    selfFreeing = true;
...
Local<v8::Value> GitSubmodule::New(const git_submodule *raw, bool selfFreeing, bool shouldDuplicate)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), Nan::New(shouldDuplicate) };
  return scope.Escape(Nan::NewInstance(Nan::New(GitSubmodule::constructor_template), 3, argv).ToLocalChecked());
}
...
void GitSubmodule::AddFinalizeWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->submodule
                         );
...
NAN_METHOD(GitSubmodule::Branch)
{
  ...
  {
    LockMaster lockMaster(true        ,    Nan::ObjectWrap::Unwrap<GitSubmodule>(info.This())->GetValue()
                         );
...
void GitSubmodule::LocationWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->location_status
                          ,baton->submodule
                         );
...
void GitSubmodule::RepoInitWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->sm
                         );
...
void GitSubmodule::StatusWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->status
                          ,baton->repo
                          ,baton->name
                         );
