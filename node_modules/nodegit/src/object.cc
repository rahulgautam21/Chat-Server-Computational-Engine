...
GitObject::GitObject(git_object *raw, bool selfFreeing, bool shouldDuplicate)
{
  if (shouldDuplicate) {
    (&this->raw, raw);
    selfFreeing = true;
...
Local<v8::Value> GitObject::New(const git_object *raw, bool selfFreeing, bool shouldDuplicate)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), Nan::New(shouldDuplicate) };
  return scope.Escape(Nan::NewInstance(Nan::New(GitObject::constructor_template), 3, argv).ToLocalChecked());
}
...
NAN_METHOD(GitObject::Free)
{
  ...
  if (Nan::ObjectWrap::Unwrap<GitObject>(info.This())->GetValue() != NULL) {
    ...
    {
      LockMaster lockMaster(true        ,    Nan::ObjectWrap::Unwrap<GitObject>(info.This())->GetValue()
                           );
...
void GitObject::LookupBypathWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->treeish
                          ,baton->path
                         );
...
void GitObject::PeelWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->object
                         );
