...
GitTag::GitTag(git_tag *raw, bool selfFreeing, bool shouldDuplicate)
{
  if (shouldDuplicate) {
    (&this->raw, raw);
    selfFreeing = true;
...
Local<v8::Value> GitTag::New(const git_tag *raw, bool selfFreeing, bool shouldDuplicate)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), Nan::New(shouldDuplicate) };
  return scope.Escape(Nan::NewInstance(Nan::New(GitTag::constructor_template), 3, argv).ToLocalChecked());
}
...
void GitTag::AnnotationCreateWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->oid
                          ,baton->repo
                          ,baton->tag_name
                          ,baton->target
                          ,baton->tagger
...
NAN_METHOD(GitTag::Free)
{
  ...
  if (Nan::ObjectWrap::Unwrap<GitTag>(info.This())->GetValue() != NULL) {
    ...
    {
      LockMaster lockMaster(true        ,    Nan::ObjectWrap::Unwrap<GitTag>(info.This())->GetValue()
                           );
...
void GitTag::ListWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(true        ,baton->tag_names
                          ,baton->repo
                         );
...
// end convert_from_v8 block
  ...
  {
    LockMaster lockMaster(true        ,    from_tag_names
                          ,    from_pattern
                          ,    from_repo
                         );
...
// end convert_from_v8 block
  ...
  {
    LockMaster lockMaster(true        ,    from_tag_target_out
                          ,    Nan::ObjectWrap::Unwrap<GitTag>(info.This())->GetValue()
                         );
