...
public:
  ...
  static Local<v8::Value> New(const git_rebase *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitRebase(git_rebase *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitRebase();
