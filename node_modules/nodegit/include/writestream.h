...
public:
  ...
  static Local<v8::Value> New(const git_writestream *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitWritestream(git_writestream *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitWritestream();
