...
public:
  ...
  static Local<v8::Value> New(const git_remote *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitRemote(git_remote *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitRemote();
