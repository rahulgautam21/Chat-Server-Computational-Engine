...
public:
  ...
  static Local<v8::Value> New(const git_checkout_options *raw, bool selfFreeing);
  ...
  struct NotifyCbBaton : public AsyncBaton {
    git_checkout_notify_t why;
    const char * path;
    const git_diff_file * baseline;
    const git_diff_file * target;
  ...
  struct PerfdataCbBaton : public AsyncBaton {
    const git_checkout_perfdata * perfdata;
    void * payload;
