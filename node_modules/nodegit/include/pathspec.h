...
public:
  ...
  static Local<v8::Value> New(const git_pathspec *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitPathspec(git_pathspec *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitPathspec();
