...
public:
  ...
  static Local<v8::Value> New(const git_config_entry *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitConfigEntry(git_config_entry *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitConfigEntry();
