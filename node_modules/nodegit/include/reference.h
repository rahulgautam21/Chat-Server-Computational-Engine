...
public:
  ...
  static Local<v8::Value> New(const git_reference *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitRefs(git_reference *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitRefs();
