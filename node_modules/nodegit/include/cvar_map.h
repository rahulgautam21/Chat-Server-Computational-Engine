...
public:
  ...
  static Local<v8::Value> New(const git_cvar_map *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitCvarMap(git_cvar_map *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitCvarMap();
