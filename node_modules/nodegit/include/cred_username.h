...
public:
  ...
  static Local<v8::Value> New(const git_cred_username *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitCredUsername(git_cred_username *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitCredUsername();
