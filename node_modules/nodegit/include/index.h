...
public:
  ...
  static Local<v8::Value> New(const git_index *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitIndex(git_index *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitIndex();
