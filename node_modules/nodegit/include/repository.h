...
public:
  ...
  static Local<v8::Value> New(const git_repository *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitRepository(git_repository *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitRepository();
