...
public:
  ...
  static Local<v8::Value> New(const git_hashsig *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitHashsig(git_hashsig *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitHashsig();
