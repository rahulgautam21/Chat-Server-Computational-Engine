...
public:
  ...
  static Local<v8::Value> New(const git_submodule *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitSubmodule(git_submodule *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitSubmodule();
