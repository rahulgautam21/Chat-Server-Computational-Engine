...
public:
  ...
  static Local<v8::Value> New(const git_transaction *raw, bool selfFreeing, bool shouldDuplicate = false);
  bool selfFreeing;
...
private:
  ...
  GitTransaction(git_transaction *raw, bool selfFreeing, bool shouldDuplicate = false);
  ~GitTransaction();
